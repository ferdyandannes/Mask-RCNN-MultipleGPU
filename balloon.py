...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 balloon.py splash --weights='/media/ee401_2/SPML/Ferdyan/v3/Mask_RCNN-master/mask_rcnn_balloon_0076.h5' --image='/media/ee401_2/SPML/Ferdyan/v3/Mask_RCNN-master/images/ski.jpg'
